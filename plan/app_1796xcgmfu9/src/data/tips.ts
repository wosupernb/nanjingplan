...
export const MOCK_TIPS: ITip[] = [
  ...
  },
  {
    id: '30',
    title: '高考生纪念馆免预约',
    description: '7月1日至9月1日，高考生凭身份证+准考证免预约进入遇难同胞纪念馆，9号门登记入馆',
    category: '其他',
    icon: '🎓',
  },
  ...
  // ========== V3.8 新增 ==========
  {
    id: '31',
    title: '★紫金山登山带足水',
    description: '7月天热登山消耗大，至少2瓶/人！每15分钟休息一次，树荫下休息，防中暑！下山注意膝盖，侧身走',
    category: '景点游玩',
    icon: '⛰️',
  },
  {
    id: '32',
    title: '灵谷寺蚊子巨多',
    description: '灵谷寺蚊子特别多！提前喷驱蚊液！灵谷塔免费必登，9层俯瞰钟山梧桐海',
    category: '景点游玩',
    icon: '🦟',
  },
  {
    id: '33',
    title: '浦口轮渡¥2看长江日落',
    description: '中山码头→浦口码头宁浦线轮渡¥2/人，约20-30分钟一班，甲板拍长江日落方向（向西），7月日落约19:00',
    category: '交通出行',
    icon: '⛴️',
  },
  {
    id: '34',
    title: 'K1557是过路站',
    description: '南京站K1557是过路站！注意大屏显示的车次和站台！提前确认车厢号和铺位，别上错车',
    category: '交通出行',
    icon: '🚂',
  },
  {
    id: '35',
    title: '明孝陵6:30前免费',
    description: '★6:30前从3号门进免门票！省¥70！晨光石象路6:30-7:30光线最佳，晚了就收费了',
    category: '景点游玩',
    icon: '🌅',
  },
];
