...
export const MOCK_ITINERARY: IItineraryDay[] = [
  {
    ...
    spots: [
      ...
      },
      {
        ...
        imageUrl: '',
        coordinates: { lng: 118.7439, lat: 32.0917 },
        highlights: [
          '民国风格建筑门头',
          '长江江景',
        ],
        photoSpots: [
          { name: '中山码头门头', tip: '民国建筑+江景背景' },
        ],
        warnings: [
      ...
      },
      {
        ...
        photoSpots: [
          { name: '甲板长江日落', tip: '向西拍日落方向，7月日落约19:00' },
        ],
        warnings: [
          '轮渡约20-30分钟一班，不用赶',
          '¥2/人，可刷支付宝或公交卡',
      ...
      },
      {
        ...
        imageUrl: '',
        coordinates: { lng: 118.7358, lat: 32.095 },
        highlights: [
          '★朱自清《背影》场景！百年老站',
          '月台+铁轨（《背影》同款）',
          '老站房+梧桐',
        ...
        route: [
          { name: '站前广场', duration: '5min', note: '出浦口码头步行5分钟到达' },
          { name: '候车大厅', duration: '10min', note: '百年老站建筑，民国风情' },
          { name: '月台', duration: '15min', note: '★朱自清《背影》同款月台+铁轨' },
          { name: '雨廊', duration: '5min', note: '连接各建筑的民国雨廊' },
          { name: '《背影》雕塑', duration: '10min', note: '打卡留念' },
        ],
        warnings: [
          '免费参观，无需预约',
      ...
      },
      {
        ...
        fee: 0,
        feeNote: '免费开放',
        transport: '中山码头→沿江边路南行步行15分钟',
        imageUrl: '',
        coordinates: { lng: 118.7417, lat: 32.0833 },
        highlights: [
          '★绿皮火车+长江日落！小众文艺打卡地',
          '铁轨+站台+江边步道',
        ],
        photoSpots: [
          { name: '绿皮火车+长江日落', tip: '傍晚7月日落约19:00，向西拍' },
          { name: '铁轨纵深', tip: '绿皮车厢+铁轨，文艺复古风' },
        ],
        route: [
          { name: '绿皮火车车厢', duration: '20min', note: '可进入车厢内部拍照' },
          { name: '铁轨+站台', duration: '15min', note: '废旧铁轨+老站台，复古风' },
          { name: '江边步道', duration: '25min', note: '沿长江步道看日落' },
        ],
        warnings: [
          '江边风大，傍晚蚊子多，提前喷驱蚊液',
          '免费开放，无门票',
