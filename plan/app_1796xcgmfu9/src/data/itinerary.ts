...
export const MOCK_ITINERARY: IItineraryDay[] = [
  ...
  },
  {
    ...
    spots: [
      {
        ...
        fee: 20,
        feeNote: '学生票半价',
        transport: '地铁1→2号线 三山街→大行宫，步行5分钟',
        imageUrl: '/images/总统府_05.jpg',
        tip: '★提前5天预约！1.5h精华游只看核心',
        coordinates: { lng: 118.7967, lat: 32.0458 },
        route: [
          { name: '中轴线', duration: '45min', note: '★精华路线：大堂（"天下为公"匾额）→ 二堂 → 礼堂（彩色玻璃窗）→ 麒麟门 → 子超楼（蒋介石办公室，二楼）' },
          { name: '东花园', duration: '20min', note: '防空洞 → 行政院，快速浏览' },
          { name: '西花园（煦园）', duration: '25min', note: '★石舫（不系舟）→ 桐音馆 → 孙中山临时大总统办公室' },
        ],
        highlights: [
          '"天下为公"匾额（大堂）',
          '礼堂彩色玻璃窗',
      ...
      },
      {
        ...
        fee: 0,
        feeNote: '民宿附近午餐人均20元',
        transport: '地铁2→1号线 大行宫→三山街',
        imageUrl: '',
        tip: '★避开正午高温！回民宿吹空调+躺平+午餐',
        coordinates: { lng: 118.782038, lat: 32.022953 },
        warnings: [
          '★7月正午35°C+，午休太重要了！',
          '民宿附近午餐，省时间省精力',
      ...
      },
      {
        ...
        photoSpots: [
          ...
          { name: '历史馆盛唐建筑风格外立面', tip: '下午光线从东南方向照来，建筑立体感强' },
        ],
        warnings: [
      ...
      },
      {
        ...
        photoSpots: [
          { name: '湖边步道逆光人像', tip: '下午5-6点逆光拍摄，湖面金光+人物剪影' },
      ...
      },
      {
        ...
        route: [
          ...
          { name: '三条营古街', duration: '10min', note: '青石板路+明清马头墙+灯笼映照' },
    ...
    dailyTotal: 30,
    dailyTotalNote: '门票合计（总统府20+鸡鸣寺10），交通12元，餐饮70元',
  },
  {
    id: '3',
    day: 3,
